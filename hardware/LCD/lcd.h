...
////////////////////////////////////////////////////////////////////
//-----------------LCD端口定义---------------- 
#define	LCD_LED PBout(10) //LCD背光    		 PC10 

#define	LCD_CS_SET  GPIO_SetOutBits(GPIOC,GPIO_PIN_13);   	//片选端口PC13
#define	LCD_RS_SET	GPIO_SetOutBits(GPIOC,GPIO_PIN_14);    	//数据/命令PC14
#define	LCD_WR_SET	GPIO_SetOutBits(GPIOC,GPIO_PIN_11);    	//写数据PC11
#define	LCD_RD_SET	GPIO_SetOutBits(GPIOC,GPIO_PIN_12);    	//读数据PC12
								    
#define	LCD_CS_CLR  GPIO_ClearOutBits(GPIOC,GPIO_PIN_13);    //片选端口PC13
#define	LCD_RS_CLR	GPIO_ClearOutBits(GPIOC,GPIO_PIN_14);    //数据/命令PC14
#define	LCD_WR_CLR	GPIO_ClearOutBits(GPIOC,GPIO_PIN_11);    //写数据PC11
#define	LCD_RD_CLR	GPIO_ClearOutBits(GPIOC,GPIO_PIN_12);    //读数据PC12
	

//PD0~15,作为数据线
#define DATAOUT(x) GPIOD->DOUTR=x; //数据输出
#define DATAIN     GPIOD->DINR;   //数据输入 
//////////////////////////////////////////////////////////////////////
//扫描方向定义
