...
{			    		   
	...
	GPIO_DirectionConfig(GPIOB,(GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_13),GPIO_DIR_OUT);
  GPIO_OpenDrainConfig(GPIOB,(GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_13),DISABLE);//推挽输出
	GPIO_DriveConfig(GPIOB,(GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_13), GPIO_DV_8MA);//设置引脚驱动电流
	GPIO_PullResistorConfig(GPIOB,(GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_13),GPIO_PR_DISABLE);
	GPIO_SetOutBits(GPIOB,(GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_13));
	
	GPIO_DirectionConfig(GPIOB,(GPIO_PIN_2|GPIO_PIN_15),GPIO_DIR_IN);
  GPIO_OpenDrainConfig(GPIOB,(GPIO_PIN_2|GPIO_PIN_15),DISABLE);//推挽输出
	GPIO_DriveConfig(GPIOB,(GPIO_PIN_2|GPIO_PIN_15), GPIO_DV_8MA);//设置引脚驱动电流
	GPIO_InputConfig(GPIOB,(GPIO_PIN_2|GPIO_PIN_15),ENABLE);//设置输入模式 
	GPIO_PullResistorConfig(GPIOB,(GPIO_PIN_2|GPIO_PIN_15),GPIO_PR_UP);
	GPIO_SetOutBits(GPIOB,(GPIO_PIN_2|GPIO_PIN_15));
